...
final appRouter = GoRouter(
  ...
  // Once onboarding is done, never show the login/onboarding flow again.
  redirect: (context, state) {
    final done = PreferencesService.instance.hasCompletedOnboarding;
    final loc = state.matchedLocation;
    if (done && (loc == '/login' || loc == '/onboarding')) {
      return '/projects';
    }
    return null;
  },
