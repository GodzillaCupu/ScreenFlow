...
const ProjectSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'type': PropertySchema(
      ...
      name: r'type',
      type: IsarType.string,
      enumMap: _ProjecttypeEnumValueMap,
    ),
...
Project _projectDeserialize(
  ...
  object.type = _ProjecttypeValueEnumMap[reader.readStringOrNull(offsets[4])] ??
      ProjectType.youtubeLongform;
...
P _projectDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (_ProjecttypeValueEnumMap[reader.readStringOrNull(offset)] ??
          ProjectType.youtubeLongform) as P;
    case 5:
      return (reader.readDateTime(offset)) as P;
    case 6:
      return (reader.readString(offset)) as P;
...
const _ProjecttypeEnumValueMap = {
  r'youtubeLongform': r'youtubeLongform',
  r'shorts': r'shorts',
  r'podcast': r'podcast',
  r'videoEssay': r'videoEssay',
  r'other': r'other',
};
const _ProjecttypeValueEnumMap = {
  r'youtubeLongform': ProjectType.youtubeLongform,
  r'shorts': ProjectType.shorts,
  r'podcast': ProjectType.podcast,
  r'videoEssay': ProjectType.videoEssay,
  r'other': ProjectType.other,
};
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> typeEqualTo(
    ProjectType value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> typeGreaterThan(
    ProjectType value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> typeLessThan(
    ProjectType value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> typeBetween(
    ProjectType lower,
    ProjectType upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> typeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> typeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> typeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> typeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> typeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'type',
        value: '',
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> typeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'type',
        value: '',
...
extension ProjectQuerySortBy on QueryBuilder<Project, Project, QSortBy> {
  ...
  QueryBuilder<Project, Project, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQuerySortThenBy
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, ProjectType, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
